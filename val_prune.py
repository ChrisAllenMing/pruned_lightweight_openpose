...
def main(labels, images_folder, checkpoint_path, output_name='detections.json', multiscale=False, visualize=False):
    ...
    net = PoseEstimationWithMobileNet_new(cfg)
    load_state(net, checkpoint)

    return evaluate(labels, output_name, images_folder, net, multiscale, visualize) 
