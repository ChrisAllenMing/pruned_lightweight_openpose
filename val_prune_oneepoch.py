...
from models.with_mobilenet import PoseEstimationWithMobileNet_new, PoseEstimationWithMobileNet
...
if __name__ == '__main__':
    ...
    checkp_prune = torch.load('/cluster/home/u4/extractor_cpm/0.8.pth.tar')
